...
var _formView = require("./view/formView");
var _formViewDefault = parcelHelpers.interopDefault(_formView);
var _historyView = require("./view/historyView");
var _historyViewDefault = parcelHelpers.interopDefault(_historyView);
...
function recordFormData(submission) {
    return _model.recordHistory(submission);
}
function renderSummary() {
    (0, _summaryViewDefault.default).renderSummary(_model.updateSummary);
}
function historyData() {
    const data = _model.historyData();
    (0, _historyViewDefault.default).renderHistory(data);
}
...
function clearSummary() {
    _model.clearSummary();
    (0, _summaryViewDefault.default).clearSummary();
}
function init() {
    (0, _historyViewDefault.default).loadHistoryOnDOMLoad(_model.historyData);
    (0, _formViewDefault.default).addFormEventHandler(recordFormData, renderSummary, historyData);
    (0, _historyViewDefault.default).clearRecords(clearHistoryData, clearSummary);
    (0, _summaryViewDefault.default).summaryDOMContentLoad(_model.updateSummary);
}
init();

},{"./model":"Py0LO","./view/formView":"lSre7","./view/historyView":"2Hlpe","./view/summaryView":"9cYTH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Py0LO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "recordHistory", ()=>recordHistory);
parcelHelpers.export(exports, "updateSummary", ()=>updateSummary);
parcelHelpers.export(exports, "historyData", ()=>historyData);
parcelHelpers.export(exports, "clearHistory", ()=>clearHistory);
parcelHelpers.export(exports, "clearSummary", ()=>clearSummary);
const state = {
    summary: {
        income: 0,
        expenses: 0,
...
},{}],"lSre7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class FormView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Hlpe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class HistoryView {
    ...
    _markup(data) {
        ...
        <p class="date">${(0, _helpers.formatDateDistance)(date)}</p>
        <p class='${category === "income" ? "income" : "expense"} amount' >${(0, _helpers.formatCurrency)(amount)}</p>
        <p class="category">${(0, _helpers.capitalizeFirstLetter)(category)}</p>
        <p class="purpose">${(0, _helpers.capitalizeFirstLetter)(purpose)}</p>
      </div>`;
    }
    _errorMessage() {
...
},{"../utilities/helpers":"9psgh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9psgh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "formatDateDistance", ()=>formatDateDistance);
...
function formatDateDistance(date) {
    ...
    if ((0, _dateFns.isToday)(dateObj)) return "Today";
    else return (0, _dateFns.formatDistanceToNow)(dateObj, {
        addSuffix: true
    }).replace("about", "");
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8oypH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../formatDistance/index.js":"lPnhm","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jEo6n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../isSameDay/index.js":"jEo6n","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9cYTH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helpers = require("../utilities/helpers");
class SummaryView {
    ...
    renderSummary(data) {
        ...
        income.textContent = (0, _helpers.formatCurrency)(newIncome);
        expenses.textContent = (0, _helpers.formatCurrency)(newExpenses);
        netIncome.textContent = (0, _helpers.formatCurrency)(newNetIncome);
    }
    ...
    clearSummary() {
        this.income.textContent = (0, _helpers.formatCurrency)(0);
        this.expenses.textContent = (0, _helpers.formatCurrency)(0);
        this.netIncome.textContent = (0, _helpers.formatCurrency)(0);
    }
}
exports.default = new SummaryView();

},{"../utilities/helpers":"9psgh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1Mgbh","1GgH0"], "1GgH0", "parcelRequiref6b8")
